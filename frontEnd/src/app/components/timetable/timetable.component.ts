...
// }else{
// return module ? module.module.responsable.nom + " " + module.module.responsable. : '';
// }
// }
...
//       }
//       else{
//         this.actons.exportFileClasse(this.selectedFiliere!.id_filiere).subscribe(
//           data=>{
//             this.spinnerExport=false;
//             console.log(data)
//             // if done, then show a success message
...
//       (department) => department.id_depart === departmentId
//     );
...
//     this.ready = true;
//     this.getEmplois(semsterId, this.selectedFiliere!.id_filiere, this.selectedDepartement!.id_depart);
//   }
// }
...
//     this.departmentService.getFilieres(this.selectedDepartement.id_depart).subscribe(
//       (data) => {
//         this.filieres = data;
//       }
//     );
...
//     this.filiereService.getSemsterByFiliere(this.selectedFiliere.id_filiere).subscribe(
//       (data) => {
//         this.semsters = data;
//       }
//     );
